...
class dotnet_002 extends dotnet_000
{
	...
	function init(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		if ($proceed)
		{
			...
			$displayobject->update_html($displayobject->make_description('<p>If you want to associate a dotnet user (in the left column) with an existing vBulletin user,
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		if ($associate_users == 1)
		{
			...
			$userarray = $this->get_dotnet_members_list($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page);
