...
*
*/
class dotnet_000 extends ImpExModule
{
	/**
	* Class version
	*
	...
	* @return	array
	*/
	function get_dotnet_members_list(&$Db_object, &$databasetype, &$tableprefix, &$start, &$per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_attachment_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_forum_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	function get_dotnet_cat_details(&$Db_object, &$databasetype, &$tableprefix)
	{	
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_moderator_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_pmtext_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_poll_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_post_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
		...
		if ($databasetype == 'mssql')
		{
			...
			while ($detail = $Db_object->fetch_array($details_list))
			{
				...
				// Get the userid
				$userid = $Db_object->query_first("SELECT UserID FROM {$tableprefix}Profiles WHERE UserGUID = '" . $detail['UserGUID'] . "'");
	...
	* @return	array
	*/
	function get_dotnet_smilie_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_thread_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_user_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
	...
	* @return	array
	*/
	function get_dotnet_usergroup_details(&$Db_object, &$databasetype, &$tableprefix, $start_at, $per_page)
	{
		$return_array = array();
