...
*
*/
class dotnet_004 extends dotnet_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '003';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$user_array 	= $this->get_dotnet_user_details($Db_source, $source_database_type, $source_table_prefix, $user_start_at, $user_per_page);
