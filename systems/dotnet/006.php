...
\*======================================================================*/
/**
* dotnet_006 Import Thread module
*
...
*
*/
class dotnet_006 extends dotnet_000
{
	var $_version 		= '0.0.1';
	var $_dependent 	= '005';
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$thread_array 	= $this->get_dotnet_thread_details($Db_source, $source_database_type, $source_table_prefix, $thread_start_at, $thread_per_page);
