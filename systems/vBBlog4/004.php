...
class vBBlog4_004 extends vBBlog4_000
{
	var $_dependent = '003';

	function vBBlog4_004(&$displayobject)
	{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($data_array['data'] as $import_id => $data)
		{
			...
			$blog_text->set_value('nonmandatory', 'state',			$data['blog_text']['state']); // enum('moderation', 'visible', 'deleted')
